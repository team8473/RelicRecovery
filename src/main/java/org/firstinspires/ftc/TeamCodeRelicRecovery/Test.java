...
@Autonomous(name="Test", group="Gabe")
...
//56.547
    ...
    private static final double     ROBOT_LONG_DIAMETER_INCHES   = 17.4;
    private static final double     ROBOT_SHORT_DIAMETER_INCHES  = 16.35;
    ...
    private void encoderTurn(double turnAngle,
        ...
        double shortSquared = Math.pow(.5 * ROBOT_SHORT_DIAMETER_INCHES, 2);
        double longSquared = Math.pow(.5 * ROBOT_LONG_DIAMETER_INCHES, 2);
